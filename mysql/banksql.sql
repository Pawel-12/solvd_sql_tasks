...
-- -----------------------------------------------------
-- Table `bank`.`TransactionPriority`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bank`.`TransactionPriority` (
  `idTransactionPriority` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  `priority` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`idTransactionPriority`),
  UNIQUE INDEX `idTransactionPriority_UNIQUE` (`idTransactionPriority` ASC) VISIBLE)
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `bank`.`MediumType`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bank`.`MediumType` (
  `idMediumType` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idMediumType`),
  UNIQUE INDEX `idMedium_UNIQUE` (`idMediumType` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bank`.`Transactions` (
  ...
  `TransactionPriority_idTransactionPriority` TINYINT UNSIGNED NOT NULL,
  `Cards_idCards` BIGINT UNSIGNED NULL,
  `MediumType_idMediumType` TINYINT UNSIGNED NOT NULL,
  `mediumNumber` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idTransactions`),
  UNIQUE INDEX `idTransactions_UNIQUE` (`idTransactions` ASC) VISIBLE,
  INDEX `fk_Transactions_Accounts1_idx` (`account` ASC) INVISIBLE,
  ...
  INDEX `fk_Transactions_TransactionPriority1_idx` (`TransactionPriority_idTransactionPriority` ASC) VISIBLE,
  INDEX `fk_Transactions_Cards1_idx` (`Cards_idCards` ASC) VISIBLE,
  INDEX `fk_Transactions_MediumType1_idx` (`MediumType_idMediumType` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Transactions_TransactionStatus1`
    ...
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Transactions_TransactionPriority1`
    FOREIGN KEY (`TransactionPriority_idTransactionPriority`)
    REFERENCES `bank`.`TransactionPriority` (`idTransactionPriority`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Transactions_Cards1`
    FOREIGN KEY (`Cards_idCards`)
    REFERENCES `bank`.`Cards` (`idCards`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Transactions_MediumType1`
    FOREIGN KEY (`MediumType_idMediumType`)
    REFERENCES `bank`.`MediumType` (`idMediumType`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
