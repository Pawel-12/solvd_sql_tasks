...
public class ClientsServiceMyBatis implements ClientsService {
    private final ClientsDao clientsDao;
    private static volatile com.solvd.laba.block2.bankhierarchy.service.mybatis.ClientsServiceMyBatis thisService = null;
    ...
    private static ConsultantsServiceMyBatis consultantsService
            = ConsultantsServiceMyBatis.getInstance(ConsultantsMyBatis.INSTANCE);

    private ClientsServiceMyBatis(ClientsDao clientsDao) {
        this.clientsDao = clientsDao;
    }

    public static synchronized com.solvd.laba.block2.bankhierarchy.service.mybatis.ClientsServiceMyBatis getInstance(ClientsDao clientsDao) {
        if (thisService == null)
            thisService = new com.solvd.laba.block2.bankhierarchy.service.mybatis.ClientsServiceMyBatis(clientsDao);
